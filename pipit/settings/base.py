...
INTERNAL_IPS = ["leacard.pythonanywhere.com"]
...
# Uploaded media
MEDIA_URL = "/wt/media/"
MEDIA_ROOT = os.path.join(BASE_DIR, "static") #"MEDIA_PATH"
...
STATIC_ROOT = os.path.join(BASE_DIR, "media") #get_env("STATIC_PATH", required=True)
...
# Prevent content type snifffing
