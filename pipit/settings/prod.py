...
DATABASES["default"]["CONN_MAX_AGE"] = int("60")
...
WAGTAILADMIN_BASE_URL = "https://leacards.com"

# Sentry
SENTRY_DSN = "SENTRY_DSN" #get_env("SENTRY_DSN", required=True)
SENTRY_ENVIRONMENT = "prod"

"""sentry_sdk.init(
    dsn=SENTRY_DSN,
    release=APP_VERSION,
    environment=None, #=SENTRY_ENVIRONMENT,
